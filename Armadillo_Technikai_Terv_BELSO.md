...
* Q oszlop dropdown: BEÉRKEZETT / HIÁNYOS\_PO / VISSZAUTASÍTVA / JÓVÁHAGYVA / BEKÖTEGELT / TELJESÍTVE / AI\_HIBA

* L oszlop: HUF / EUR  |  M oszlop: PROJEKT / ÁLLANDÓ

* Sorok színkódja Q oszlop alapján: kék→sárga→piros→zöld→lila→szürke→sötétpiros
...
* KÖTEGEK fülre sor \+ BEKÖTEGELT státusz update \+ Chat értesítő Péternek (Drive link)
...
* \+3 napos ellenőrző: naponta fut, BEKÖTEGELT ahol utalás dátuma \> 3 napja → Chat Péternek
